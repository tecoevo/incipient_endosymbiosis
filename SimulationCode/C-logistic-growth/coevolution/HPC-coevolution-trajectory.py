...
trait_trajectoryH = np.array(trait_trajectoryH)
trait_trajectoryS = np.array(trait_trajectoryS)

omegaH_traj = np.around(trait_trajectoryH[:,0], 4)
omegaS_traj= np.around(trait_trajectoryS[:,0], 4)

alphaH_traj = np.around(trait_trajectoryH[:,1], 4)
alphaS_traj = np.around(trait_trajectoryS[:,1], 4)
